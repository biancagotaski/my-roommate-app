...
// This example below is when you have 2 environments (prod and dev)
// In that case you should have 2 firebase configs (which you should setup on firebase as well...)
// const configEnv = process.env.NODE_ENV === 'production' ? prodConfig : devConfig;
